...
if df_base is not None:
    ...
    # Красивый дизайнерский блок шпаргалки с цветными карточками рецептов
    exp = st.expander("🏍️ Шпаргалка: Как изменить поведение мотоцикла?")
    ...
    <div class="recipe-card">
        <div class="recipe-q">❌ Жестко на кочках (бьет в руки/руль)?</div>
        <p class="recipe-a"><span class="status-ok">✔ Решение:</span> Открутите (против часовой стрелки в сторону <b>S</b>) винт <b>Сжатия</b> на передней вилке на 1–2 щелчка. Это сделает вилку мягче при обработке неровностей.</p>
    </div>
    
    <div class="recipe-card">
        <div class="recipe-q">❌ Мотоцикл раскачивается как лодка (после прыжка или волны)?</div>
        <p class="recipe-a"><span class="status-ok">✔ Решение:</span> Подвеске не хватает контроля возврата пружины. Закрутите (по часовой стрелке в сторону <b>H</b>) винты <b>Отбоя</b> на передней вилке и снизу заднего амортизатора на 1–2 щелчка.</p>
    </div>
    
    <div class="recipe-card">
        <div class="recipe-q">❌ Задняя подвеска пробивает до упора (с пассажиром или багажом)?</div>
        <p class="recipe-a"><span class="status-ok">✔ Решение:</span> Не хватает жесткости пружины. Накрутите черную выносную рукоятку <b>Преднатяга</b> сжатия задней пружины по часовой стрелке на 3–5 щелчков больше, чем выдает калькулятор.</p>
    </div>
    
    <div class="recipe-card">
        <div class="recipe-q">❌ Морда мотоцикла задирается, руль пустой и легкий на скорости?</div>
        <p class="recipe-a"><span class="status-ok">✔ Решение:</span> Мотоцикл слишком просел назад. Увеличьте <b>Преднатяг</b> задней пружины рукояткой на 2–3 щелчка, либо уменьшите <b>Преднатяг</b> передней вилки на 0.5–1 риску, чтобы опустить нос байка.</p>
    </div>
    
    <div class="recipe-card">
        <div class="recipe-q">❌ Мотоцикл неохотно заходит в повороты (сопротивляется рулению)?</div>
        <p class="recipe-a"><span class="status-ok">✔ Решение:</span> Перед завышен, а зад слишком занижен. Добавьте 2–3 щелчка <b>Преднатяга</b> сзади, чтобы приподнять хвост мотоцикла. Геометрия изменится, и байк станет рулиться намного острее.</p>
    </div>
    """, unsafe_allow_html=True)
